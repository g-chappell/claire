...
def make_tasks_chain(llm):
    ...
    prompt = ChatPromptTemplate.from_messages([
        ("system",
            ...
            "• Ordering (authoritative): every task MUST include priority_rank (1..K, gap-free, 1 = highest); the app will **not** reorder or infer defaults. Missing/invalid ranks will cause failure.\n"
